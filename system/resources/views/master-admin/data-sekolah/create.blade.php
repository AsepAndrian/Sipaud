            ...
            <form action="{{ url('master-admin/data-sekolah') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form">
                    ...
                    <div class="form-label-wrapper">
                        ...
                        <input type="text" name="nama_sekolah" class="form-input" placeholder="Masukkan nama sekolah" required />
                    </div>

                    <div class="form-label-wrapper">
                        <label for="npsn" class="form-label">NPSN</label>
                        <input type="text" name="npsn" class="form-input" placeholder="Masukkan NPSN" required />
                    </div>
